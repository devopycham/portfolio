...
/**
 * Scrambles text into cipher noise, then resolves it back to the real
 * string character-by-character. Screen readers always get the plain
 * text via a visually-hidden span, independent of the animated state.
 */
